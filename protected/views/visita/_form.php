...
<div class="form">
    ...
    <div class="span4">
        ...
        <input type="date" data-clear-btn="false" name="fecha_recordatorio" id="fecha_recordatorio" value="">
        <?php echo TbHtml::textArea('texto_recordatorio', '', array('rows' => 6,'span'=>12,'placeholder'=>'Recordatorio')); ?>
    </div>
    </div>
    <div class="row">
